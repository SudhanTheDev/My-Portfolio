          ...
          >
            {timeline.map((item, index) => (
              <motion.div
                ...
                className="group relative border-l border-border pl-8 transition-all duration-500 hover:border-purple-400/60"
              >
                <div className="timeline-node absolute left-0 top-2 h-3 w-3 -translate-x-[6.5px] rotate-45 bg-zinc-700 transition-all duration-500 group-hover:rotate-[135deg] group-hover:bg-purple-300 group-hover:shadow-[0_0_16px_rgba(192,132,252,0.9)]" />
                <div className="timeline-panel p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-purple-500/15">

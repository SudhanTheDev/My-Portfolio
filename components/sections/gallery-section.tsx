      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {filteredImages.map((image, index) => (
            ...
            >
              <motion.div 
                className="relative aspect-[4/5] overflow-hidden bg-zinc-900 mb-4"
              ...
              <motion.span 
                ...
                className="text-xs text-zinc-500 font-mono tracking-wider mb-1 block"
              >
                {image.category}
              </motion.span>
              <motion.h3 
                ...
                className="text-lg font-medium text-white group-hover:text-zinc-300 transition-colors duration-300"
              >
                {image.title}
              </motion.h3>
            </motion.button>
